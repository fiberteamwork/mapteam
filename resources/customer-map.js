...
function setupGeolocateControl() {
    try {
        ...
        // place at top-right of the map/viewport instead of bottom-right
        btn.style.top = '16px';
...
function openDataView() {
    ...
    try { const gb = document.getElementById('geolocate-btn'); if (gb) gb.style.display = 'none'; } catch (e) {}
...
function closeDataView() {
    ...
    try { const gb = document.getElementById('geolocate-btn'); if (gb) gb.style.display = ''; } catch (e) {}
}
