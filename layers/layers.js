...
lyr_SIDOARJO_1.set('fieldAliases', {'DESA': 'DESA', 'KECAMATAN': 'KECAMATAN', 'CITY': 'CITY', });
lyr_surabaya_2.set('fieldAliases', {'CITY': 'CITY', 'KECAMATAN': 'KECAMATAN', 'DESA': 'DESA', });
lyr_SIDOARJO_1.set('fieldImages', {'DESA': 'TextEdit', 'KECAMATAN': 'TextEdit', 'CITY': 'TextEdit', });
lyr_surabaya_2.set('fieldImages', {'CITY': 'TextEdit', 'KECAMATAN': 'TextEdit', 'DESA': 'TextEdit', });
lyr_SIDOARJO_1.set('fieldLabels', {'DESA': 'no label', 'KECAMATAN': 'no label', 'CITY': 'no label', });
lyr_surabaya_2.set('fieldLabels', {'CITY': 'no label', 'KECAMATAN': 'no label', 'DESA': 'no label', });
